...
public class Feedback {
  ...
  // Pseudofeedback code whenever we are given feedback parameters
  public void pseudoFeedback (int num, double Alpha, double Beta, double Gamma) {
	  DocumentReference docRef;
	  // Add first x documents to goodDoc list
	  for (int x = 0; x < num; x++) {
		docRef = retrievals[x].docRef;
		addGood(docRef);
	  }
	  // Set new parameters
	  ALPHA = Alpha;
  ...
  // Pseudofeedback code whenever we are not given feedback parameters. Use defaults
  public void pseudoFeedback (int num) {
	  DocumentReference docRef;
	  // Add first x documents to goodDoc list
	  for (int x = 0; x < num; x++) {
		docRef = retrievals[x].docRef;
  ...
  public HashMapVector newQuery() {
	...
	HashMapVector newQuery = null;
	if (queryVector != null) {
		newQuery = queryVector.copy();
	}
