...
public class Experiment {
  ...
  // Variables needed for pseudofeedback
  
  // Use pseudofeedback or not
  public static boolean pseudofeedback = false;
  
  // What number of first docs should itset as good
  public static int pseudoCheck = 0;
  
  // Parameters for pseudo feedback
  public static double feedbackALPHA = 0;
  public static double feedbackBETA = 0;
  public static double feedbackGAMMA = 0;
  
  // If there are parameters
  public static boolean feedbackparams = false;
  ...
  // Second constructor for pseudofeedback use
  public Experiment(File corpusDir, File queryFile, File outFile, short docType, boolean stem, boolean pseudofeedback, boolean feedbackparams)
      throws IOException {
    this.corpusDir = corpusDir;
    this.index = new InvertedIndex(corpusDir, docType, stem, false, pseudofeedback, feedbackparams, feedbackALPHA, feedbackBETA, feedbackGAMMA, pseudoCheck);
    this.queryFile = queryFile;
    this.outFile = outFile;
  }
